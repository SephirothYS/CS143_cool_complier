    ...
    */
    ...
    expression : assign_expression
               ...
               | expression '.' OBJECTID '(' expression_list ')'
                  {$$ = dispatch($1, $3, $5);}
               | expression '@' TYPEID '.' OBJECTID '(' ')'  %prec FLAG
    ...
    assign_expression : OBJECTID ASSIGN expression
                          {$$ = assign($1, $3);}
    ...
    let_expression : OBJECTID ':' TYPEID assign_opt IN expression %prec FLAG
                      {$$ = let($1, $3, $4, $6);}
                   | OBJECTID ':' TYPEID assign_opt ',' let_expression
                      {$$ = let($1, $3, $4, $6);}
